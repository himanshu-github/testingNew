...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.labelFont = [UIFont fontWithName:@"Roboto-Condensed" size:kLabelFontSize];
        self.detailsLabelFont = [UIFont fontWithName:@"Roboto-Condensed" size:kDetailsLabelFontSize];
