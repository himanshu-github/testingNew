...
@interface DKPredicate : NSObject {
	NSPredicate *__unsafe_unretained predicate;
	NSDictionary *__unsafe_unretained info;

	DKPredicateType predicateType;
}

@property (unsafe_unretained, nonatomic, readonly) NSPredicate *predicate;
@property (unsafe_unretained, nonatomic, readonly) NSDictionary *info;
