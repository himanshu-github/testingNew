...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.font = [UIFont fontWithName:@"Roboto-Condensed" size:CSToastFontSize];
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont fontWithName:@"Roboto-Condensed" size:CSToastFontSize];
